...
def move_logos(logos, width, height):
    for logo in logos:
        ...
        elif logo["y"] <= 1 and logo["direction"] == "ul": 
            logo["direction"] = "dl"
        elif logo["y"] <= 1 and logo["direction"] == "ur": 
            logo["direction"] = "dr"
        elif logo["y"] >= height-2 and logo["direction"] == "dl": 
            logo["direction"] = "ul"
        elif logo["y"] >= height-2 and logo["direction"] == "dr": 
            logo["direction"] = "ur"
